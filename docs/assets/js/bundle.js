 ...
 */
            function (e) {
                ...
                for (t in n = se.support = {}, o = se.isXML = function (e) {
                    ...
                    return a != d && 9 === a.nodeType && a.documentElement ? (h = (d = a).documentElement, g = !o(d), w != d && (i = d.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener('unload', oe, !1) : i.attachEvent && i.attachEvent('onunload', oe)), n.scope = ce((function (e) {
                        return h.appendChild(e)
                            .appendChild(d.createElement('div')), void 0 !== e.querySelectorAll && !e.querySelectorAll(':scope fieldset div').length;
                        ...
                        t.setAttribute('type', 'hidden'), e.appendChild(t)
                            .setAttribute('name', 'D'), e.querySelectorAll('[name=d]').length && v.push('name' + R + '*[*^$|!~]?='), 2 !== e.querySelectorAll(':enabled').length && v.push(':enabled', ':disabled'), h.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(':disabled').length && v.push(':enabled', ':disabled'), e.querySelectorAll('*,:x'), v.push(',.*:');
                    ...
                    pseudos: {
                        ...
                        lang: le((function (e) {
                            return V.test(e || '') || se.error('unsupported lang: ' + e), e = e.replace(te, ne)
                    ...
                    return r && !r[b] && (r = Ce(r)), i && !i[b] && (i = Ce(i, o)), le((function (o, a, s, u) {
                        ...
                        if (o) {
                            if (i || e) {
                                ...
                                for (c = m.length; c--;) (f = m[c]) && (l = i ? H(o, f) : p[c]) > -1 && (o[l] = !(a[l] = f));
                            }
                        } else {
                            m = Te(m === a ? m.splice(h, m.length) : m), i ? i(null, a, m, u) : L.apply(a, m);
                        }
                    }));
                }
                    ...
                    for (var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[' '], u = a ? 1 : 0, c = be((function (e) {
                        ...
                        if (n = r.relative[e[u].type]) {
                            ...
                            if ((n = r.filter[e[u].type].apply(null, e[u].matches))[b]) {
                                ...
                                return Ce(u > 1 && we(p), u > 1 && xe(e.slice(0, u - 1)
                ...
                return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, a = se.tokenize = function (e, t) {
                    ...
                    return t ? s.length : s ? se.error(e) : S(e, u)
                        .slice(0);
                            ...
                            var n = t.length > 0,
                                ...
                                o = function (o, a, s, u, c) {
                                    ...
                                    if (m += y, n && y !== m) {
                                        ...
                                        if (o) {
                                            if (m > 0) for (; y--;) x[y] || b[y] || (b[y] = _.call(u));
                                            b = Te(b);
                                        }
                    ...
                    if (n = n || [], 1 === d.length) {
                        ...
                        for (o = G.needsContext.test(e) ? 0 : u.length; o-- && (l = u[o], !r.relative[c = l.type]);) {
                            if ((f = r.find[c]) && (i = f(l.matches[0].replace(te, ne), ee.test(u[0].type) && me(t.parentNode) || t))) {
                                if (u.splice(o, 1), !(e = i.length && xe(u))) return L.apply(n, i), n;
                                break;
                            }
                        }
                    }
                    ...
                    .sort(j)
                    .join('') === b, n.detectDuplicates = !!f, p(), n.sortDetached = ce((function (e) {
        ...
        (C.fn.init = function (e, t, n) {
            ...
            if (n = n || q, 'string' == typeof e) {
                ...
                if (r[1]) {
                    if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), D.test(r[1]) && C.isPlainObject(t)) for (r in t) m(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                    return this;
                }
        ...
        C.fn.extend({
            ...
            index: function (e) {
                return e ? 'string' == typeof e ? c.call(C(e), this[0]) : c.call(this, e.jquery ? e[0] : e) : this[0] && this[0].parentNode ? this.first()
                    .prevAll().length : -1;
            },
            add: function (e, t) {
            ...
            C.fn[e] = function (n, r) {
                ...
                return 'Until' !== e.slice(-5) && (r = n), r && 'string' == typeof r && (i = C.filter(r, i)), this.length > 1 && (H[e] || C.uniqueSort(i), O.test(e) && i.reverse()), this.pushStack(i);
            };
        }));
        var R = /[^\x20\t\r\n\f]+/g;
                ...
                var t = [['notify', 'progress', C.Callbacks('memory'), C.Callbacks('memory'), 2], ['resolve', 'done', C.Callbacks('once memory'), C.Callbacks('once memory'), 0, 'resolved'], ['reject', 'fail', C.Callbacks('once memory'), C.Callbacks('once memory'), 1, 'rejected']],
                    ...
                    i = {
                                ...
                                C.each(t, (function (t, r) {
                                    ...
                                    o[r[1]]((function () {
                                        ...
                                        e && m(e.promise) ? e.promise()
                                            .progress(n.notify)
                                            .done(n.resolve)
                                            .fail(n.reject) : n[r[0] + 'With'](this, i ? [e] : arguments);
                                    }));
                                })), e = null;
                            }))
                                .promise();
                        ...
                        then: function (e, r, i) {
                                    ...
                                    var s = this,
                                        ...
                                        l = function () {
                                            ...
                                            if (!(e < o)) {
                                                ...
                                                l = n && ('object' == typeof n || 'function' == typeof n) && n.then, m(l) ? i ? l.call(n, a(o, t, M, i), a(o, t, I, i)) : (o++, l.call(n, a(o, t, M, i), a(o, t, I, i), a(o, t, M, t.notifyWith))) : (r !== M && (s = void 0, u = [n]), (i || t.resolveWith)(s, u));
                                            }
                                        },
                                        c = i ? l : function () {
                                            try {
                            ...
                            return C.Deferred((function (n) {
                                t[0][3].add(a(0, n, m(i) ? i : M, n.notifyWith)), t[1][3].add(a(0, n, m(e) ? e : M)), t[2][3].add(a(0, n, m(r) ? r : I));
                            }))
                                .promise();
                        },
                        promise: function (e) {
        ...
        de = x.createDocumentFragment()
            .appendChild(x.createElement('div')), (he = x.createElement('input')).setAttribute('type', 'radio'), he.setAttribute('checked', 'checked'), he.setAttribute('name', 't'), de.appendChild(he), v.checkClone = de.cloneNode(!0)
            .cloneNode(!0).lastChild.checked, de.innerHTML = '<textarea>x</textarea>', v.noCloneChecked = !!de.cloneNode(!0).lastChild.defaultValue, de.innerHTML = '<option></option>', v.option = !!de.lastChild;
        var ye = {
            thead: [1, '<table>', '</table>'],
        ...
        function Te(e, t, n, r, i) {
            ...
            for (f.textContent = '', d = 0; o = p[d++];) if (r && C.inArray(o, r) > -1) i && i.push(o); else if (l = ae(o), a = xe(f.appendChild(o), 'script'), l && be(a), n) for (c = 0; o = a[c++];) me.test(o.type || '') && n.push(o);
            return f;
        }
            ...
            n ? (J.set(e, t, !1), C.event.add(e, t, {
                ...
                handler: function (e) {
                    ...
                    if (1 & e.isTrigger && this[t]) {
                        ...
                        o.length && (J.set(this, t, { value: C.event.trigger(C.extend(o[0], C.Event.prototype), o.slice(1), this) }), e.stopImmediatePropagation());
                    }
                }
        ...
        C.event = {
            ...
            add: function (e, t, n, r, i) {
                ...
                if (Y(e)) {
                    for (n.handler && (n = (o = n).handler, i = o.selector), i && C.find.matchesSelector(oe, i), n.guid || (n.guid = C.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function (t) {
                        ...
                        d = g = (s = Se.exec(t[l]) || [])[1], h = (s[2] || '').split('.')
                            .sort(), d && (f = C.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = C.event.special[d] || {}, c = C.extend({
                            type: d,
                            origType: g,
                            data: r,
                            handler: n,
            ...
            remove: function (e, t, n, r, i) {
                ...
                if (v && (u = v.events)) {
                    for (l = (t = (t || '').match(R) || ['']).length; l--;) {
                        if (d = g = (s = Se.exec(t[l]) || [])[1], h = (s[2] || '').split('.')
                            .sort(), d) {
                ...
                if (u && l.nodeType && !('click' === e.type && e.button >= 1)) {
                    for (; l !== this; l = l.parentNode || this) {
                        if (1 === l.nodeType && ('click' !== e.type || !0 !== l.disabled)) {
                            for (o = [], a = {}, n = 0; n < u; n++) {
                                void 0 === a[i = (r = t[n]).selector + ' '] && (a[i] = r.needsContext ? C(i, this)
                                    .index(l) > -1 : C.find(i, this, null, [l]).length), a[i] && o.push(r);
                            }
                            o.length && s.push({
                                elem: l,
                                handlers: o
            ...
            off: function (e, t, n) {
                ...
                if (e && e.preventDefault && e.handleObj) {
                    return r = e.handleObj, C(e.delegateTarget)
        ...
        function Oe(e, t) {
            return N(e, 'table') && N(11 !== t.nodeType ? t : t.firstChild, 'tr') && C(e)
                .children('tbody')[0] || e;
        }
        ...
        function Ie(e, t, n, r) {
            ...
            if (p && (o = (i = Te(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                ...
                if (s) for (c = a[a.length - 1].ownerDocument, C.map(a, Pe), f = 0; f < s; f++) l = a[f], me.test(l.type || '') && !J.access(l, 'globalEval') && C.contains(c, l) && (l.src && 'module' !== (l.type || '').toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, { nonce: l.nonce || l.getAttribute('nonce') }, c) : w(l.textContent.replace(Le, ''), l, c));
            }
            return e;
        }
        ...
        C.extend({
            ...
            clone: function (e, t, n) {
                var r,
                    ...
                    s = e.cloneNode(!0),
                    u = ae(e);
                if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e))) for (a = xe(s), r = 0, i = (o = xe(e)).length; r < i; r++) Me(o[r], a[r]);
            ...
            text: function (e) {
                return z(this, (function (e) {
                    return void 0 === e ? C.text(this) : this.empty()
                        .each((function () {
            ...
            html: function (e) {
                return z(this, (function (e) {
                    ...
                    if ('string' == typeof e && !_e.test(e) && !ye[(ve.exec(e) || ['', ''])[1].toLowerCase()]) {
                        e = C.htmlPrefilter(e);
                        try {
        ...
        function Ue(e, t, n) {
            var r,
                ...
                a,
                s = e.style;
            return (n = n || $e(e)) && ('' !== (a = n.getPropertyValue(t) || n[t]) || ae(e) || (a = C.style(e, t)), !v.pixelBoxStyles() && Fe.test(a) && ze.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + '' : a;
        }
        ...
        !function () {
            function e() {
                if (c) {
                    l.style.cssText = 'position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0', c.style.cssText = 'position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%', oe.appendChild(l)
                        .appendChild(c);
            ...
            c.style && (c.style.backgroundClip = 'content-box', c.cloneNode(!0).style.backgroundClip = '', v.clearCloneStyle = 'content-box' === c.style.backgroundClip, C.extend(v, {
                ...
                reliableTrDimensions: function () {
                    var e,
                        ...
                        r,
                        i;
                    return null == s && (e = x.createElement('table'), t = x.createElement('tr'), r = x.createElement('div'), e.style.cssText = 'position:absolute;left:-11111px', t.style.height = '1px', r.style.height = '9px', oe.appendChild(e)
                        .appendChild(t)
                        .appendChild(r), i = n.getComputedStyle(t), s = parseInt(i.height) > 3, oe.removeChild(e)), s;
                }
            }));
        }();
        ...
        C.extend({
            ...
            C.cssHooks[t] = {
                get: function (e, n, r) {
                    if (n) {
                        return !Je.test(C.css(e, 'display')) || e.getClientRects().length && e.getBoundingClientRect().width ? rt(e, t, r) : Be(e, Ze, (function () {
                            return rt(e, t, r);
                        }));
                    }
                },
            ...
            if (t) {
                return (parseFloat(Ue(e, 'marginLeft')) || e.getBoundingClientRect().left - Be(e, { marginLeft: 0 }, (function () {
        ...
        function dt(e, t, n) {
            ...
            for (!function (e, t) {
                ...
                if (r = dt.prefilters[o].call(l, e, c, l.opts)) return m(r.stop) && (C._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
            }
            return C.map(c, pt, l), m(l.opts.start) && l.opts.start.call(e, l), l.progress(l.opts.progress)
                .done(l.opts.done, l.opts.complete)
                .fail(l.opts.fail)
                .always(l.opts.always), C.fx.timer(C.extend(u, {
                elem: e,
                anim: l,
                queue: l.opts.queue
            })), l;
            ...
            prefilters: [function (e, t, n) {
                ...
                if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(d)) {
                    for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = J.get(e, 'display')), 'none' === (c = C.css(e, 'display')) && (l ? c = l : (pe([e], !0), l = e.style.display || l, c = C.css(e, 'display'), pe([e]))), ('inline' === c || 'inline-block' === c && null != l) && 'none' === C.css(e, 'float') && (u || (p.done((function () {
                        ...
                        u || (v ? 'hidden' in v && (g = v.hidden) : v = J.access(e, 'fxshow', { display: l }), o && (v.hidden = !g), g && pe([e], !0), p.done((function () {
        ...
        C.fn.extend({
            val: function (e) {
                ...
                return arguments.length ? (r = m(e), this.each((function (n) {
                    var i;
                    1 === this.nodeType && (null == (i = r ? e.call(this, n, C(this)
                        .val()) : e) ? i = '' : 'number' == typeof i ? i += '' : Array.isArray(i) && (i = C.map(i, (function (e) {
                        return null == e ? '' : e + '';
        ...
        C.extend(C.event, {
            trigger: function (e, t, r, i) {
                ...
                if (a = p = s = r = r || x, 3 !== r.nodeType && 8 !== r.nodeType && !Tt.test(g + C.event.triggered) && (g.indexOf('.') > -1 && (v = g.split('.'), g = v.shift(), v.sort()), l = g.indexOf(':') < 0 && 'on' + g, (e = e[C.expando] ? e : new C.Event(g, 'object' == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = v.join('.'), e.rnamespace = e.namespace ? new RegExp('(^|\\.)' + v.join('\\.(?:.*\\.|)') + '(\\.|$)') : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : C.makeArray(t, [e]), f = C.event.special[g] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, t))) {
                    ...
                    return e.type = g, i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !Y(r) || l && m(r[g]) && !y(r) && ((s = r[l]) && (r[l] = null), C.event.triggered = g, e.isPropagationStopped() && p.addEventListener(g, Ct), r[g](), e.isPropagationStopped() && p.removeEventListener(g, Ct), C.event.triggered = void 0, s && (r[l] = s)), e.result;
                }
            },
        ...
        function _t(e, t, n, r) {
            ...
            if (Array.isArray(t)) {
                C.each(t, (function (t, i) {
                    n || At.test(e) ? r(e, i) : _t(e + '[' + ('object' == typeof i && null != i ? t : '') + ']', i, n, r);
                }));
            } else if (n || 'object' !== T(t)) r(e, t); else for (i in t) _t(e + '[' + i + ']', t[i], n, r);
        }
                ...
                return this.map((function () {
                    ...
                    .filter((function () {
                        ...
                        return this.name && !C(this)
                            .is(':disabled') && Dt.test(this.nodeName) && !Nt.test(e) && (this.checked || !ge.test(e));
                    }))
                    .map((function (e, t) {
                        var n = C(this)
                            .val();
        ...
        Ft.href = Et.href, C.extend({
            ...
            ajax: function (e, t) {
                ...
                if (v.promise(E), d.url = ((e || d.url || Et.href) + '').replace(Rt, Et.protocol + '//'), d.type = t.method || t.type || d.method || d.type, d.dataTypes = (d.dataType || '*').toLowerCase()
                    .match(R) || [''], null == d.crossDomain) {
                    u = x.createElement('a');
                    try {
                ...
                if (d.data && d.processData && 'string' != typeof d.data && (d.data = C.param(d.data, d.traditional)), Bt(Mt, d, t, E), l) return E;
                for (f in (c = C.event && d.global) && 0 == C.active++ && C.event.trigger('ajaxStart'), d.type = d.type.toUpperCase(), d.hasContent = !Pt.test(d.type), i = d.url.replace(Lt, ''), d.hasContent ? d.data && d.processData && 0 === (d.contentType || '').indexOf('application/x-www-form-urlencoded') && (d.data = d.data.replace(qt, '+')) : (p = d.url.slice(i.length), d.data && (d.processData || 'string' == typeof d.data) && (i += (kt.test(i) ? '&' : '?') + d.data, delete d.data), !1 === d.cache && (i = i.replace(Ot, '$1'), p = (kt.test(i) ? '&' : '?') + '_=' + St.guid++ + p), d.url = i + p), d.ifModified && (C.lastModified[i] && E.setRequestHeader('If-Modified-Since', C.lastModified[i]), C.etag[i] && E.setRequestHeader('If-None-Match', C.etag[i])), (d.data && d.hasContent && !1 !== d.contentType || t.contentType) && E.setRequestHeader('Content-Type', d.contentType), E.setRequestHeader('Accept', d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ('*' !== d.dataTypes[0] ? ', ' + Wt + '; q=0.01' : '') : d.accepts['*']), d.headers) E.setRequestHeader(f, d.headers[f]);
                if (d.beforeSend && (!1 === d.beforeSend.call(h, E, d) || l)) return E.abort();
                if (T = 'abort', m.add(d.complete), E.done(d.success), E.fail(d.error), r = Bt(It, d, t, E)) {
                ...
                function S(e, t, a, u) {
                    ...
                    }(d, b, E, f), f ? (d.ifModified && ((w = E.getResponseHeader('Last-Modified')) && (C.lastModified[i] = w), (w = E.getResponseHeader('etag')) && (C.etag[i] = w)), 204 === e || 'HEAD' === d.type ? T = 'nocontent' : 304 === e ? T = 'notmodified' : (T = b.state, p = b.data, f = !(x = b.error))) : (x = T, !e && T || (T = 'error', e < 0 && (e = 0))), E.status = e, E.statusText = (t || T) + '', f ? v.resolveWith(h, [p, T, E]) : v.rejectWith(h, [E, T, x]), E.statusCode(y), y = void 0, c && g.trigger(f ? 'ajaxSuccess' : 'ajaxError', [E, d, f ? p : x]), m.fireWith(h, [E, T]), c && (g.trigger('ajaxComplete', [E, d]), --C.active || C.event.trigger('ajaxStop')));
                }
            ...
            wrapAll: function (e) {
                var t;
                return this[0] && (m(e) && (e = e.call(this[0])), t = C(e, this[0].ownerDocument)
                    .eq(0)
        ...
        C.ajaxSetup({
            ...
            if (s || 'jsonp' === e.dataTypes[0]) {
                return i = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Yt, '$1' + i) : !1 !== e.jsonp && (e.url += (kt.test(e.url) ? '&' : '?') + e.jsonp + '=' + i), e.converters['script json'] = function () {
                    return a || C.error(i + ' was not called'), a[0];
                }, e.dataTypes[0] = 'json', o = n[i], n[i] = function () {
                    a = arguments;
                }, r.always((function () {
                    void 0 === o ? C(n)
                        .removeProp(i) : n[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, Gt.push(i)), a && m(o) && o(a[0]), a = o = void 0;
                })), 'script';
            }
            ...
            return 'string' != typeof e ? [] : ('boolean' == typeof t && (n = t, t = !1), t || (v.createHTMLDocument ? ((r = (t = x.implementation.createHTMLDocument('')).createElement('base')).href = x.location.href, t.head.appendChild(r)) : t = x), o = !n && [], (i = D.exec(e)) ? [t.createElement(i[1])] : (i = Te([e], t, o), o && o.length && C(o)
                .remove(), C.merge([], i.childNodes)));
            var r,
                i,
                o;
                ...
                if (this[0]) {
                    ...
                    if ('fixed' === C.css(r, 'position')) {
                        ...
                        e && e !== r && 1 === e.nodeType && ((i = C(e)
                            .offset()).top += C.css(e, 'borderTopWidth', !0), i.left += C.css(e, 'borderLeftWidth', !0));
                    }
                    return {
        ...
        }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = N, C.isFunction = m, C.isWindow = y, C.camelCase = G, C.type = T, C.now = Date.now, C.isNumeric = function (e) {
            var t = C.type(e);
    ...
    function o() {
        ...
        402 === r && (e.animate({
            ...
            i()(".content")
                .fadeIn("slow"), e.fadeOut("fast"), t.fadeOut("fast")
        }), 3500)
    }

    function a() {
        i()(".experience__controller__item")
            .on("click", (function () {
                var e = i()(this)
                    .attr("skill");
                i()(".experience__controller__item--selected").length;
                i()(this)
                    .hasClass("experience__controller__item--selected") ? (i()("div[skill='".concat(e, "']"))
                    .removeClass("experience__controller__item--selected"), function () {
                    var e = 0 !== i()(".experience__controller__item--selected").length;
                    e || i()(".experience__clear-button")
                        .css("display", "none")
                        .hide()
                        .fadeOut()
                }()) : (i()("div[skill='".concat(e, "']"))
                    .addClass("experience__controller__item--selected"), i()(".experience__clear-button")
                    .css("display", "flex")
                    .hide()
                    .fadeIn()), function () {
                    var e = 0 !== i()(".experience__controller__item--selected").length;
                    e && (i()(".experience__container__list__boxes__box")
                        .each((function () {
                            var e = i()(".experience__controller__item--selected");
                            0 !== i()(this)
                                .find(e).length ? i()(this)
                                .css("display", "flex")
                                .hide()
                                .fadeIn() : i()(this)
                                .css("display", "none")
    ...
    function s() {
        a(), i()(".experience__clear-button")
            .on("click", (function () {
                i()(".experience__container__list")
                    .css("display", "flex")
                    .hide()
                    .fadeIn(), i()(".experience__container__list__boxes__box")
                    .css("display", "flex")
                    .hide()
                    .fadeIn(), i()(".experience__controller__item--selected")
                    .removeClass("experience__controller__item--selected"), i()(this)
                    .css("display", "none")
                    .hide()
                    .fadeOut()
            })), i()(".experience__container__list__boxes__box__learn-more")
            .on("click", (function () {
                var e = i()(this)
                    .attr("link");
                window.open(e)
    ...
    window.$ = i.a, window.jQuery = i.a, i()(window)
        .on("load", (function () {
            o()
        })), i()(document)
        .ready((function () {
    ...
    var u = document.querySelector(".theme-switch"),
        l = localStorage.getItem("theme");
    u.addEventListener("change", (function (e) {
        o(), e.target.checked ? (document.documentElement.setAttribute("data-theme", "dark"), localStorage.setItem("theme", "dark")) : (document.documentElement.setAttribute("data-theme", "light"), localStorage.setItem("theme", "light"))
    }), !1), l && (document.documentElement.setAttribute("data-theme", l), "dark" === l && (u.checked = !0))
}]);
